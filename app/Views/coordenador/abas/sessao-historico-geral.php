                                            ...
                                            <td class="pe-4 text-end">
                                                <?php if ($h['status'] == 'pendente'): ?>
                                                    <form method="POST" action="painel_coordenador.php" class="d-inline">
                                                        ...
                                                        <button type="submit" name="acao_reserva" value="aprovar" class="btn btn-sm btn-success rounded-circle" title="Aprovar"><i class="bi bi-check-lg"></i></button>
                                                    </form>
                                                    <form method="POST" action="painel_coordenador.php" class="d-inline ms-1">
                                                        <input type="hidden" name="id_agendamento" value="<?= $h['id'] ?>">
                                                        <button type="submit" name="acao_reserva" value="rejeitar" class="btn btn-sm btn-danger rounded-circle" title="Rejeitar"><i class="bi bi-x-lg"></i></button>
                                                    </form>
                                                <?php else: ?>
