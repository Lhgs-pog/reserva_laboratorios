...
// ── Bootstrap Eloquent (Capsule) ─────────────────────────────────────────────
// Database::getInstance() chama setAsGlobal() + bootEloquent() internamente.
// Sem isso, qualquer chamada Eloquent (User::where, etc.) lança:
...
function getControllerAndAction() {
    ...
    $routes = [
        ...
        'check_sos_status' => ['SOSController', 'listarStatus'],   // corrigido
    ];
...
function executeRouter() {
    ...
    // 2. Injeta o Request no construtor do Controller
    // Agora o AuthController vai receber o $request corretamente!
