...
class SOS extends BaseModel {
    ...
    public function listarStatus() {
        ...
        $html_suporte = '';
        if ($qtd_suporte > 0) {
            $html_suporte .= '<div class="alert alert-danger rounded-0 border-0 border-start border-4 border-danger shadow-sm mb-3">';
            $html_suporte .= '<strong><i class="bi bi-exclamation-triangle-fill me-2"></i>' . $qtd_suporte . ' chamado(s) SOS pendente(s):</strong><ul class="mb-0 mt-2">';
